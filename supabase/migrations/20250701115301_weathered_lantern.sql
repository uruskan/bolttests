/*
  # Initial Database Schema for SayNDone Restaurant Dashboard

  1. New Tables
    - `restaurants` - Restaurant information and settings
    - `user_restaurants` - User-restaurant associations with roles
    - `categories` - Menu categories
    - `products` - Menu items/products
    - `content_items` - Stories, advertisements, featured content
    - `analytics_events` - User interaction tracking
    - `audit_logs` - Action audit trail for AI assistant

  2. Security
    - Enable RLS on all tables
    - Add policies for restaurant-based access control
    - Ensure users can only access their own restaurant data
